...
set mouse=a
set pastetoggle=<F10>
set runtimepath=~/.vim,~/.vim/bundle/syntastic/,~/.vim/bundle/typescript-vim/,~/.vim/bundle/indentLine/,~/.vim/bundle/vim-jsbeautify/,~/.vim/bundle/.neobundle,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/neobundle.vim/,~/.vim/bundle/indentLine/after
set shiftwidth=2
set showcmd
set smartcase
set smartindent
...
exe 'vert 1resize ' . ((&columns * 90 + 90) / 181)
exe 'vert 2resize ' . ((&columns * 90 + 90) / 181)
tabedit ~/Documents/Git/flight-map/package.json
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 2resize ' . ((&columns * 90 + 90) / 181)
argglobal
noremap <buffer>  :call JsonBeautify()
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
edit ~/Documents/Git/flight-map/webpack.config.js
noremap <buffer>  :call JsBeautify()
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
